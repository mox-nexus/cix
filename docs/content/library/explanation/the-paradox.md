...
thought the AI had helped (Becker et al. 2025).
...
benefited more — both in adoption rate and magnitude of productivity gain (Cui et al. 2024, SSRN).
...
The most plausible reconciliation: AI helps on unfamiliar ground, hurts on familiar ground. This is
...
was unanimous and wrong (Becker et al. 2025).
...
complete the task faster: the time difference was not statistically significant (p=0.391)
(Shen & Tamkin 2026, arXiv).
...
performance as a consequence of copying solutions" (Bastani et al. 2025, PNAS).
...
information is retained approximately 22% better than passively received information
(Slamecka & Graf 1978).
...
arrives pre-resolved — the writer never had to form the thought (Bereiter & Scardamalia 1987).
...
and troubleshoot, 5-15 queries (Iterative AI Debugging: 24%). Each pattern, from inside, looks like competent tool use.
...
Relative decline: 21% (Budzyń et al. 2025, Lancet).
...
provides the answer before the learner can attempt the problem (Natali et al. 2025).
...
can't get the tool to generate what they want (Liang et al. 2024, ICSE).
