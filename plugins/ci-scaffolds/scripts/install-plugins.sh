...
# Available plugins
PLUGINS=(
  "ci-scaffolds:Research-grounded scaffolds for collaborative building"
  "guild-arch:Architectural reasoning with The Guild"
  "craft-research:Research synthesis and deep research methodology"
...
usage() {
  ...
  echo "  $0 ci-scaffolds rust-1337      # Install specific plugins"
