---
name: collaboration
description: "This skill should be used when the user asks to 'calibrate trust', 'improve collaboration', 'work together effectively', or needs human-AI collaboration patterns, trust calibration, or partnership quality improvement."
---
...
| **Binary thinking** | Presenting orthogonal dimensions as primary/secondary | Collapses valid options, forces false choices |

**Binary thinking** deserves special attention. Two valid approaches can be orthogonal dimensions, not competing alternatives. Domain answers "what am I building?" — concern answers "what am I worried about?" — and they compose. Presenting one as primary and the other as a "shortcut" or "fallback" collapses the option space before the human even sees it. The fix: name the different questions each approach answers, show how they combine.
