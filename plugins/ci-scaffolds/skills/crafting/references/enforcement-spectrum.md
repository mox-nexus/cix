...
- [Current ci-scaffolds Enforcement Map](#current-ci-scaffolds-enforcement-map)
...
**Most ci-scaffolds hooks are suggestive** — they preserve agency while creating strong behavioral nudges.
...
**ci-scaffolds currently has no blocking hooks** — all are suggestive by design, preserving agency.
...
## Current ci-scaffolds Enforcement Map
