...
**The pattern**: "This isn't X. It's Y." — or softer: "Not just X. Y." — when X and Y are both true.

| Instance | What's wrong | Fix |
|----------|-------------|-----|
| "This isn't ethics. It's structure." | It's both. Dismissing one weakens the other. | Hold multiplicity, or just say the structural point. |
| "Not just bad for people. Bad for themselves." | Same system, fake distinction. | "Bad for both — because they're the same system." |
| "This isn't a manifesto. It's a description." | A description of why something must exist IS a manifesto. | Delete the denial, or own the manifesto. |
| "Not a constraint. A requirement." | Synonyms in context. Performs distinction without content. | Pick one word and commit. |

**Why it's an LLM tell**: LLMs love this construction because it mimics intellectual sharpness — "I'm cutting through to the real thing." The move is hollow. Real precision doesn't dismiss adjacent truths.

**The test**: Cover the first half. Does the second half stand alone? If yes, the denial is performing, not contributing — delete it. If no, the whole thing leans on false contrast.

**The fix**: Hold multiplicity ("both A and B, and here's why they're connected") or just state the claim without saying what it isn't. The strongest claims don't introduce themselves by denial.
