...
When you build an LLM skill or agent, you need empirical measurement of whether it works. This guide shows you how to run the build-evals self-evaluation harness.

## The Core Problem

You've built the build-evals plugin. Now you want to verify it actually works before shipping. The harness tests two questions:
...
This tests whether Claude follows the build-evals methodology when activated.
...
Before shipping the build-evals plugin:
