...
description: "This skill should be used when the user asks to 'analyze these papers', 'synthesize research findings', 'extract claims from papers', 'compare methodologies', 'do a literature review', or needs multi-paper synthesis and research gap analysis."
---
