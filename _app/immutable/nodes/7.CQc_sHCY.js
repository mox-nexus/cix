import{H as _e}from"../chunks/D0iwhpLH.js";import{a as Le,b as Me,r as qe}from"../chunks/BAv6qQ-A.js";import{c as ce,a as h,f as b,t as re}from"../chunks/SVdUZQyt.js";import{p as J,f as ee,a as Y,V as P,s as I,c as r,r as a,t as E,j as t,aa as _,m as Q,am as le,g as Be,Z as me,d as De,$ as Ge}from"../chunks/BHP_F0dA.js";import{b as K}from"../chunks/VSWUfKDS.js";import{o as he}from"../chunks/Bt5n71lR.js";import{i as C}from"../chunks/DzV3BEOZ.js";import{e as ve,s as G,a as Z,b as fe,i as ye,h as ze}from"../chunks/D5DZRJ6s.js";import{b as we}from"../chunks/BCWzkpJg.js";import{d as He,w as Re}from"../chunks/Dpu6jzGp.js";import{M as Ne,p as We}from"../chunks/DSo03KUO.js";import{s as z,d as be}from"../chunks/Dy_Q1MKo.js";import{p as Oe,s as je,a as Fe}from"../chunks/Ckm2j_Wp.js";const Xe=`# Bibliography
...
<span id="kazemitabaar-2025" class="ev ev-moderate" title="IUI peer-reviewed, N=124 total">◐</span> **Kazemitabaar, S. et al. (2025).** Cognitive Engagement Techniques for AI-Assisted Code Learning. IUI 2025. N=82 + N=42 = 124 total. Seven friction techniques tested; Lead-and-Reveal most effective. Population: novice undergrads (18-23), data structures course.
...
The convergence problem from the [previous article](/docs/same-tool-different-design): AI outputs are measurably less diverse than human outputs (g=-0.863, [Holzner et al. 2025](/docs/bibliography#holzner-2025), n=8,214). [Jiang et al.](/docs/bibliography#jiang-2025) demonstrated that 70+ language models independently reach for the same metaphors, the same framings, across different architectures.
...
The observable phenomenon: project names (Sentinel, Forge, Nexus), website aesthetics, UX patterns, all converging through shared AI systems.

<chart id="naming-convergence"></chart>

A marketplace of preset skills accelerates this. Teams reach for the same options, framed the same way, and the distinctiveness that was always downstream of the human thinking drains out. The collapse [Shumailov et al.](/docs/bibliography#shumailov-2024) documented at the model level has an analog at the culture level.

The response inverts the marketplace dynamic. Every skill interaction should produce a project-specific instance reflecting what the human brought — not a template customized with the human's name, but a methodology applied to the human's actual constraints, beliefs, and context. The skill is the method. The output is yours.

This is the newest principle and the least validated. The research establishes that engagement model matters ([Bastani et al. 2025](/docs/bibliography#bastani-2025), PNAS), that mastery orientation produces dramatically different outcomes (OR=35.8, [Pallant 2025](/docs/bibliography#pallant-2025)), and that process control is the strongest measured lever (b=0.715, [Blaurock et al. 2025](/docs/bibliography#blaurock-2025)). Marketplace as methodology is our synthesis of those findings into marketplace-level design.

Whether it works at scale is being evaluated. This honesty is structural, not decorative — if the methodology doesn't produce meaningfully different outputs across teams, it's a principle statement without evidence behind it, and the design should change.
...
`;function ge(i,e){throw new _e(i,e)}async function Ue(i){const e=Le(i);if(!e)throw ge(404,`Not found: ${i}`);const l=e.file??i,c=Object.assign({"../../../../content/docs/bibliography.md":Xe,"../../../../content/docs/index.md":Ke,"../../../../content/docs/same-tool-different-design.md":Je,"../../../../content/docs/the-design-choices-behind-cix.md":Ye,"../../../../content/docs/the-productivity-trap.md":Ve}),f=`../../../../content/docs/${l}.md`,u=c[f];if(!u)throw ge(404,`Content not found: ${l}`);const T=Me(i);return{content:u,metadata:{},slug:i,entry:e,...T??{}}}const Qe=({params:i})=>Ue(i.slug),Dt=Object.freeze(Object.defineProperty({__proto__:null,load:Qe},Symbol.toStringTag,{value:"Module"})),Te="cix-reading-progress",de={entries:{}};function Ze(){try{const i=localStorage.getItem(Te);if(i)return{...de,...JSON.parse(i)}}catch{}return de}function $e(i){try{localStorage.setItem(Te,JSON.stringify(i))}catch{}}function et(){const{subscribe:i,update:e}=Re(Ze());return i($e),{subscribe:i,markVisited(l){e(c=>c.entries[l]==="completed"?c:{...c,entries:{...c.entries,[l]:"visited"}})},markCompleted(l){e(c=>({...c,entries:{...c.entries,[l]:"completed"}}))},toggleCompleted(l){e(c=>{const u=(c.entries[l]||"unvisited")==="completed"?"visited":"completed";return{...c,entries:{...c.entries,[l]:u}}})},reset(){e(()=>de)}}}const $=et();He($,i=>{const e=Object.values(i.entries);return{visited:e.filter(l=>l==="visited").length,completed:e.filter(l=>l==="completed").length,total:e.length}});var tt=b("<li><a> </a></li>"),nt=b('<nav class="toc svelte-a0qt5x" aria-label="Table of contents"><h4 class="toc-title svelte-a0qt5x">On this page</h4> <ul class="toc-list svelte-a0qt5x"></ul></nav>');function at(i,e){J(e,!0);let l=Oe(e,"headings",19,()=>[]),c=_("");he(()=>{if(l().length===0)return;const v=new IntersectionObserver(p=>{p.forEach(y=>{y.isIntersecting&&P(c,y.target.id,!0)})},{rootMargin:"-20% 0% -70% 0%"});return l().forEach(({id:p})=>{const y=document.getElementById(p);y&&v.observe(y)}),()=>v.disconnect()});var f=ce(),u=ee(f);{var T=v=>{var p=nt(),y=I(r(p),2);ve(y,21,l,ye,(x,S)=>{let D=()=>t(S).id,g=()=>t(S).text,m=()=>t(S).level;var k=tt(),w=r(k);let A;var R=r(w,!0);a(w),a(k),E(()=>{G(w,"href",`#${D()??""}`),A=Z(w,1,"toc-link svelte-a0qt5x",null,A,{active:t(c)===D()}),fe(w,`padding-left: ${(m()-2)*12}px`),z(R,g())}),h(x,k)}),a(y),a(p),h(v,p)};C(u,v=>{l().length>0&&v(T)})}h(i,f),Y()}var it=b('<span class="check-icon svelte-1nqvhwz">&#10003;</span> Read',1),st=b('<span class="circle-icon svelte-1nqvhwz">&#9675;</span> Mark as read',1),ot=b('<span class="position-label svelte-1nqvhwz"> </span>'),rt=b('<span class="related-meta svelte-1nqvhwz"> </span>'),lt=b('<li><a class="related-link svelte-1nqvhwz"><span><!></span> <span><span class="related-name svelte-1nqvhwz"> </span> <!></span></a></li>'),dt=b('<div class="related-section svelte-1nqvhwz"><h4 class="related-title svelte-1nqvhwz">Related</h4> <ul class="related-list svelte-1nqvhwz"></ul></div>'),ct=b('<a class="nav-prev svelte-1nqvhwz"><span class="nav-arrow svelte-1nqvhwz">&larr;</span> <span class="nav-label"> </span></a>'),ht=b("<span></span>"),ut=b('<a class="nav-next svelte-1nqvhwz"><span class="nav-label"> </span> <span class="nav-arrow svelte-1nqvhwz">&rarr;</span></a>'),pt=b('<a class="nav-next svelte-1nqvhwz"><span class="nav-label">Back to Docs</span> <span class="nav-arrow svelte-1nqvhwz">&rarr;</span></a>'),mt=b('<footer class="article-footer svelte-1nqvhwz"><div class="read-action svelte-1nqvhwz"><button><!></button> <!></div> <!> <nav class="seq-nav svelte-1nqvhwz" aria-label="Article navigation"><div class="seq-nav-links svelte-1nqvhwz"><!> <!></div></nav></footer>');function gt(i,e){J(e,!0);const l=()=>Fe($,"$readingProgress",c),[c,f]=je();let u=Q(()=>l().entries[e.slug]||"unvisited"),T=Q(()=>t(u)==="completed"),v=Q(()=>e.entry?.related?qe(e.entry.related):[]);var p=mt(),y=r(p),x=r(y);let S;x.__click=()=>$.toggleCompleted(e.slug);var D=r(x);{var g=n=>{var s=it();le(),h(n,s)},m=n=>{var s=st();le(),h(n,s)};C(D,n=>{t(T)?n(g):n(m,!1)})}a(x);var k=I(x,2);{var w=n=>{var s=ot(),o=r(s);a(s),E(()=>z(o,`${e.position??""} of ${e.total??""}`)),h(n,s)};C(k,n=>{e.position&&e.total&&n(w)})}a(y);var A=I(y,2);{var R=n=>{var s=dt(),o=I(r(s),2);ve(o,21,()=>t(v),ye,(M,q)=>{const te=Q(()=>l().entries[t(q).slug]||"unvisited");var ne=lt(),ae=r(ne),U=r(ae);let ue;var ke=r(U);{var Ae=B=>{var H=re("✓");h(B,H)},Ie=B=>{var H=ce(),se=ee(H);{var Ce=X=>{var oe=re("●");h(X,oe)},Ee=X=>{var oe=re("○");h(X,oe)};C(se,X=>{t(te)==="visited"?X(Ce):X(Ee,!1)},!0)}h(B,H)};C(ke,B=>{t(te)==="completed"?B(Ae):B(Ie,!1)})}a(U);var pe=I(U,2),ie=r(pe),xe=r(ie,!0);a(ie);var Se=I(ie,2);{var Pe=B=>{var H=rt(),se=r(H);a(H),E(()=>z(se,`${t(q).readMinutes??""} min`)),h(B,H)};C(Se,B=>{t(q).readMinutes&&B(Pe)})}a(pe),a(ae),a(ne),E(()=>{G(ae,"href",`${K??""}/docs/${t(q).slug??""}`),ue=Z(U,1,"related-indicator svelte-1nqvhwz",null,ue,{completed:t(te)==="completed"}),z(xe,t(q).title)}),h(M,ne)}),a(o),a(s),h(n,s)};C(A,n=>{t(v).length>0&&n(R)})}var j=I(A,2),F=r(j),N=r(F);{var L=n=>{var s=ct(),o=I(r(s),2),M=r(o,!0);a(o),a(s),E(()=>{G(s,"href",`${K??""}/docs/${e.prev.slug??""}`),z(M,e.prev.title)}),h(n,s)},W=n=>{var s=ht();h(n,s)};C(N,n=>{e.prev?n(L):n(W,!1)})}var d=I(N,2);{var O=n=>{var s=ut(),o=r(s),M=r(o,!0);a(o),le(2),a(s),E(()=>{G(s,"href",`${K??""}/docs/${e.next.slug??""}`),z(M,e.next.title)}),h(n,s)},V=n=>{var s=pt();E(()=>G(s,"href",`${K??""}/docs`)),h(n,s)};C(d,n=>{e.next?n(O):n(V,!1)})}a(F),a(j),a(p),E(()=>{S=Z(x,1,"mark-read-btn svelte-1nqvhwz",null,S,{completed:t(T)}),G(x,"aria-pressed",t(T))}),h(i,p),Y(),f()}be(["click"]);var vt=b('<div class="ev-source svelte-ep7riq"> </div>'),ft=b('<div><div class="ev-level svelte-ep7riq"><span class="ev-symbol"> </span> </div> <!></div>');function yt(i,e){J(e,!0);const l={strong:"STRONG",moderate:"MODERATE",weak:"WEAK",speculative:"SPECULATIVE"},c={strong:"●",moderate:"◐",weak:"○",speculative:"◌"};let f=_(0),u=_(0),T=_(!1),v=_(void 0);function p(){if(!e.target||!t(v)||(P(T,window.matchMedia("(max-width: 900px)").matches,!0),t(T)))return;const g=e.target.getBoundingClientRect(),m=t(v).getBoundingClientRect();let k=g.left+g.width/2-m.width/2;const w=12;k=Math.max(w,Math.min(k,window.innerWidth-m.width-w));let A=g.top-m.height-8;A<w&&(A=g.bottom+8),P(f,k,!0),P(u,A,!0)}Be(()=>{e.visible&&e.target&&t(v)&&requestAnimationFrame(p)});function y(){if(!e.visible||t(T)||!e.target)return;const g=e.target.getBoundingClientRect();g.top>-g.height&&g.bottom<window.innerHeight+g.height?p():e.onclose()}he(()=>(window.addEventListener("scroll",y,{passive:!0}),()=>window.removeEventListener("scroll",y)));var x=ce(),S=ee(x);{var D=g=>{var m=ft();let k;m.__keydown=L=>{L.key==="Escape"&&e.onclose()};var w=r(m),A=r(w),R=r(A,!0);a(A);var j=I(A);a(w);var F=I(w,2);{var N=L=>{var W=vt(),d=r(W,!0);a(W),E(()=>z(d,e.source)),h(L,W)};C(F,L=>{e.source&&L(N)})}a(m),we(m,L=>P(v,L),()=>t(v)),E(()=>{k=Z(m,1,"ev-popover svelte-ep7riq",null,k,{mobile:t(T)}),G(m,"data-level",e.level),fe(m,t(T)?"":`left: ${t(f)}px; top: ${t(u)}px;`),z(R,c[e.level]),z(j,` ${l[e.level]??""}`)}),h(g,m)};C(S,g=>{e.visible&&g(D)})}h(i,x),Y()}be(["keydown"]);var wt=b('<nav class="article-back svelte-wdxtx4"><a class="svelte-wdxtx4">&larr; docs</a></nav>'),bt=b('<div class="article-layout svelte-wdxtx4"><article class="library-prose svelte-wdxtx4"><nav class="article-breadcrumb svelte-wdxtx4"><a class="svelte-wdxtx4">docs</a></nav> <!> <!></article> <aside class="article-sidebar svelte-wdxtx4"><!></aside></div> <!>',1);function Tt(i,e){J(e,!0);let l=_(me([])),c=_(me(e.metadata?.title||"")),f=_(void 0),u=_(null),T=_("moderate"),v=_(""),p=_(!1);function y(d){return d.classList.contains("ev-strong")?"strong":d.classList.contains("ev-moderate")?"moderate":d.classList.contains("ev-weak")?"weak":d.classList.contains("ev-speculative")?"speculative":"moderate"}function x(d){P(u,d,!0),P(T,y(d),!0),P(v,d.getAttribute("title")||"",!0),P(p,!0),d.removeAttribute("title"),d.dataset.title=t(v)}function S(){t(u)&&t(u).dataset.title&&(t(u).setAttribute("title",t(u).dataset.title),delete t(u).dataset.title),P(p,!1),P(u,null)}he(()=>{if(!t(f))return;e.slug&&$.markVisited(e.slug);const d=t(f).querySelector("h1");d&&!t(c)&&P(c,d.textContent||"",!0);const O=t(f).querySelectorAll("h2, h3");P(l,Array.from(O).map(o=>({id:o.id,text:o.textContent||"",level:parseInt(o.tagName[1])})),!0),t(f).querySelectorAll(".ev").forEach(o=>{o.setAttribute("tabindex","0"),o.setAttribute("role","note");const M=o.getAttribute("title");M&&o.setAttribute("aria-label",`Evidence: ${M}`),o.addEventListener("click",q=>{q.stopPropagation(),t(p)&&t(u)===o?S():x(o)}),o.addEventListener("keydown",q=>{(q.key==="Enter"||q.key===" ")&&(q.preventDefault(),t(p)&&t(u)===o?S():x(o))})});function n(o){if(!t(p))return;const M=o.target;M.closest(".ev")||M.closest(".ev-popover")||S()}function s(o){o.key==="Escape"&&t(p)&&S()}return document.addEventListener("click",n),document.addEventListener("keydown",s),()=>{document.removeEventListener("click",n),document.removeEventListener("keydown",s)}});var D=bt();ze("wdxtx4",d=>{De(()=>{Ge.title=`${(t(c)||"Article")??""} — cix Docs`})});var g=ee(D),m=r(g),k=r(m),w=r(k);a(k);var A=I(k,2);Ne(A,{get md(){return e.content},get plugins(){return We}});var R=I(A,2);{var j=d=>{gt(d,{get slug(){return e.slug},get entry(){return e.entry},get prev(){return e.prev},get next(){return e.next},get position(){return e.position},get total(){return e.total}})},F=d=>{var O=wt(),V=r(O);a(O),E(()=>G(V,"href",`${K??""}/docs`)),h(d,O)};C(R,d=>{e.slug?d(j):d(F,!1)})}a(m),we(m,d=>P(f,d),()=>t(f));var N=I(m,2),L=r(N);at(L,{get headings(){return t(l)}}),a(N),a(g);var W=I(g,2);yt(W,{get target(){return t(u)},get level(){return t(T)},get source(){return t(v)},get visible(){return t(p)},onclose:S}),E(()=>G(w,"href",`${K??""}/docs`)),h(i,D),Y()}function Gt(i,e){J(e,!0),Tt(i,{get slug(){return e.data.slug},get entry(){return e.data.entry},get content(){return e.data.content},get metadata(){return e.data.metadata},get position(){return e.data.position},get total(){return e.data.total},get prev(){return e.data.prev},get next(){return e.data.next}}),Y()}export{Gt as component,Dt as universal};
