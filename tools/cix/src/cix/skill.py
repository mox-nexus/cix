"""cix skill loader - loads skill documentation from package assets.

Skills are versioned with the package in src/cix/assets/skills/.
"""
...
def _get_skill_files() -> resources.abc.Traversable:
    ...
    return resources.files("cix.assets") / "skills" / "cix"
