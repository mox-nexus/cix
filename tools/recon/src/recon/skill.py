"""Recon skill loader — loads skill documentation from package assets.

Skills are versioned with the package in src/recon/assets/skills/.
Accessed via `recon --skill` and `recon --skill -r <reference>`.
"""
...
def _get_skill_files() -> resources.abc.Traversable:
    ...
    return resources.files("recon.assets") / "skills" / "recon"
